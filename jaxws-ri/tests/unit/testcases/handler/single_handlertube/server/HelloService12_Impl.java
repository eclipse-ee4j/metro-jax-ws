...
@jakarta.jws.WebService(serviceName = "HelloService12", portName="HelloPort12", targetNamespace="urn:test", endpointInterface="handler.single_handlertube.server.Hello12")
