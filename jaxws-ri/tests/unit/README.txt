...
* Additionally you should add xmlunit library to lib/ext folder.
Jar: https://github.com/eclipse-ee4j/metro-jax-ws/blob/master/jaxws-ri/tests/unit/lib/ext/xmlunit1.0.jar
Sources: https://github.com/eclipse-ee4j/metro-jax-ws/blob/master/jaxws-ri/tests/unit/lib/ext/xmlunit-1.0-src.zip