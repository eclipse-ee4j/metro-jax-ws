...
//        });
    ...
    public URI getAddress() {
        ...
        if (webModule == null) {
            throw APISupport.createException("Container " + endpoint.getContainer() + " doesn't support " + WebModule.class);
        }
    ...
    public URI getAddress(String base) {
        try {
            ...
            throw APISupport.createException("Unable to compute address for " + endpoint, ex);
        }
    }
